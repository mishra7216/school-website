...
const PlaygroundPage = () => {
  ...
  const images = [
    { id: 1, url: '/playground-1.jpg', span: 'col-span-2 row-span-2', alt: 'Best Sports Facilities in Baihar - School Cricket Ground Balaghat - Little Kingdom School Playground Baihar - Baihar ka sabse acha school - Balaghat ka sabse acha school - बैहर का सबसे अच्छा स्कूल - बालाघाट का सबसे अच्छा स्कूल' },
    { id: 2, url: '/playground-2.jpg', span: 'col-span-1 row-span-1', alt: 'Indoor Kabaddi Hall Baihar - Best Sports School in Balaghat - Little Kingdom School Sports Facility - Baihar ka sabse acha school - Balaghat ka sabse acha school - बैहर का सबसे अच्छा स्कूल - बालाघाट का सबसे अच्छा स्कूल' },
    { id: 3, url: '/playground-3.jpg', span: 'col-span-1 row-span-1', alt: 'School Sports Facilities Baihar Balaghat - Best School Playground in Baihar MP - Little Kingdom School - Baihar ka sabse acha school - Balaghat ka sabse acha school - बैहर का सबसे अच्छा स्कूल - बालाघाट का सबसे अच्छा स्कूल' },
