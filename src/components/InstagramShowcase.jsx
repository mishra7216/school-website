...
const fallbackPosts = [
  ...
  { id: 3, image: '/kindergarten-banner-1.jpg', alt: 'Kindergarten Joyful Learning - Little Kingdom School Baihar Instagram', caption: '🧸 Little Learners, Big Dreams', likes: 189, category: 'Campus' },
