...
const GalleryPreview = () => {
  const images = [
    ...
    { id: 'republic-day-performance', src: '/gallery-3.jpg', caption: 'Republic Day Performance', alt: 'Republic Day Baihar - First Prize Dance Performance - Best School in Baihar Balaghat - Little Kingdom School - Best school in Baihar - Best school in Balaghat - Baihar ka sabse acha school - Balaghat ka sabse acha school - बैहर का सबसे अच्छा स्कूल - बालाघाट का सबसे अच्छा स्कूल', to: '/republic-day' },
